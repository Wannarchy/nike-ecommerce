...
prev.item(0).addEventListener('click', prevSlide);
next.item(0).addEventListener('click', nextSlide);
...
function nextSlide() {
    slideIndex = (slideIndex + 1) % slides.length; // Incrémente l'indice de la diapositive actuelle
    showSlide(slideIndex); // Affiche la diapositive suivante
}


function prevSlide() {
    slideIndex = (slideIndex - 1 + slides.length) % slides.length; // Incrémente l'indice de la diapositive actuelle
showSlide(slideIndex); // Affiche la diapositive suivante
}
